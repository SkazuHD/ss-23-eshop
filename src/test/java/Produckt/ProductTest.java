...
public class ProductTest {
    ...
    @Test  void testProduckt() {
        ProductManager productManger = new ProductManager();
        productManger.addProduct( "Horst", 3.99, 4 );
        Assertions.assertEquals(1,productManger.productsSet.size());
    }

    @Test void removeProductQuantiy(){
        ProductManager productManger = new ProductManager();
        productManger.addProduct( "Horst", 3.99, 4 );
    ...
    @Test void  removeProductComplete(){
        ProductManager productManger = new ProductManager();
        productManger.addProduct( "Horst", 3.99, 4 );
        productManger.removeProduct("Horst", 4);
        Assertions.assertEquals(0,productManger.productsSet.size());
